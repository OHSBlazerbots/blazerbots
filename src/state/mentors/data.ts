...
const mentorData: MentorProps[] = [
  ...
  { name: "Daniel Brandt", since: "2019", image: daniel_brandt, role: "Team Coach", bio: "Mr. Brandt started mentoring in 2019 and teaches physics and robotics at Overland. As a mentor he focuses on helping students design the robot in CAD, as well as assisting with 3D printing and other manufacturing." },
  ...
  { name: "Abraham Selenke", since: "2022", image: abraham_selenke, role: "Leadership", bio: "Abraham joined the BlazerBots as a mentor for the 2023 season, after participating as a student for three years (from 2013-2015), and quickly connected with the students! His focuses as a mentor include teaching leadership skills, helping enhance communication between subteams, and guiding the electrical team. Abraham also spearheaded the recent effort to create an independent booster club for the BlazerBots. For all of these efforts, he was awarded the 2023/24 Overland Volunteer of the Year Award." },
  { name: "Autumn Dekay", since: "2022", image: autumn_dekay, role: "Design and Build", bio: "Autumn began mentoring the BlazerBots for the 2023 season, having participated as a student for four years (2012-2015). Autumn brings mechanical engineering, CAD, and manufacturing knowledge to the team." },
  { name: "Joey Muller", since: "2022", image: joey_muller, role: "Programming", bio: "Joey joined the BlazerBots as a mentor for the 2023 season, after participating in high school for two years (2014-2015). Joey works as a software engineer and brings those skills to the BlazerBots, where he leads the small but dedicated programming team. He assists them with setting realistic goals and with communicating the sub-team's needs to the rest of the team." },
  { name: "Sam Goldman", since: "2022", image: sam_goldman, role: "Fundraising and Drive Team", bio: "Sam joined the BlazerBots as a mentor for the 2023 season, after participating in high school for four years (2013-2016). He focuses his mentoring efforts on advising students on overall game strategy and on training the drive team. He also serves as the drive coach when needed. Outside of strategy, he focuses on finding corporate sponsors and funding the team so students can focus on building the robot!" },
  { name: "Talya Goldman", since: "2023", image: talya_goldman, role: "Electrical and CAD", bio: "Talya joined in 2024, after participating as a student for three years (2014-2017). Talya studied Biomedical Enginnering in school and brings mechanical engineering and CAD skills to the team, and also helps mentor the electrical team." },
  { name: "Scott Miller", since: "2023", image: scott_miller, role: "Build", bio: "Scott joined in 2024 and works as a Guidance, Navigation, and Controls engineer for the United Launch alliance. Scott brings his knowledge of woodworking to the team, and has generally focused on assisting with the build process. The 2024 season was Scott's first ever exposure to FRC, but he's looking forward to many more!" },
];
